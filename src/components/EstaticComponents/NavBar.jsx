        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav mr-auto">
            <li className="nav-item active">
              <NavLink className="nav-link pl-6" to="/contactus">Contacto<span className="sr-only"></span></NavLink>
            </li>
            <li className="nav-item">
              <NavLink className="nav-link pl-6" to="/jobfavorites">Favoritos</NavLink>
            </li>
          </ul>
        </div>
          <form className="d-flex search-bar" role="search">
                <input className="form-control rounded-pill" type="search" aria-label="Search"></input>
                <button className="btn" type="submit" placeholder=""><i class="bi bi-search"></i></button>
          </form>
      </nav>
    </div>
)
